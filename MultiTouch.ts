import CameraMoveScript from "./script/common/CameraMoveScript";
    ...
    constructor(){
		...
		var resource = [
			...
			"res/Conventional/weizou.ls",
			"res/Conventional/terrain/terrain_Terrain.lm",
			"res/Conventional/terrain/terrain_Terrain.lmat",
	];
    ...
    onComplete(){
		...
		// var scene = Laya.stage.addChild(Laya.Loader.getRes("res/Conventional/weizou.ls")) as Laya.Scene3D;
		//创建相机
